    ...
    <div class="seventeen section section-even clear">
        <div class="landing-container">
            ...
            <div class="col-2">
                ...
                <p>
                    <?php echo sprintf( __('Do you wish your %1$sshop manager%2$s to take care of the points collecting scheme without giving the %1$sauthorization%2$s to manage the plugin?%3$s No worries, we have the right solution. ','yith-woocommerce-points-and-rewards'),'<b>','</b>','<br>'); ?>
                </p>
                <p>
    ...
    <div class="nineteen section section-even clear">
        <div class="landing-container">
            ...
            <div class="col-2">
                ...
                <p>
                    <?php echo sprintf( __('From now, also those purchasing by redeeming their points can %1$sbenefit of free shipping%2$s.%3$s Decide whether offering this opportunity or not. ','yith-woocommerce-points-and-rewards'),'<b>','</b>','<br>'); ?>
                </p>
            </div>
        </div>
    </div>
