...
Description: YITH WooCommerce Points and Rewards allows you to start a rewarding program in your site and encourage your customers to collect points.
Version: 1.1.0
Author: YTHEMES
...
if ( defined( 'YITH_YWPAR_VERSION' ) ) {
    ...
    define( 'YITH_YWPAR_VERSION', '1.1.0' );
}
